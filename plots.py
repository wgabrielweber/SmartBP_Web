...
def plotRawAndFilteredData(measure):
    ...
    alphas = [0.75, 0.75, 1.0, 1.0, 0.75, 0.75]
    linewidths = [0.5, 0.5, 1.0, 1.0, 1.0, 1.0]
    ...
    return plot_signals_generic(measure, signals_to_plot, "Raw and Filtered Signals Comparison", labels, colors, alphas, linewidths)
